<x-layouts>
    ...
    <div class="card-body">
        <x-table.datatable tablename="bahan" barisdata="20" hiddenfilter1="" filter1name="kategori :" :filter1array="$bahankategoris" filter1collumn="nama_kategori" filter1colnumber="5" hiddenfilter2="true">
            <thead>
                <tr>
