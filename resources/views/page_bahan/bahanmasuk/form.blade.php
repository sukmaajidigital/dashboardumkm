<x-forms.select-input required="required" label="Nama Bahan" id="bahan_id" name="bahan_id" :options="$bahans->pluck('nama_bahan', 'id')" :selected="old('bahan_id', $bahanmasuk->bahan_id ?? '')" />
...
<x-forms.select-input required="required" label="Supplier" id="supplier_id" name="supplier_id" :options="$suppliers->pluck('nama_supplier', 'id')" :selected="old('supplier_id', $bahanmasuk->supplier_id ?? '')" />
