<div class="mx-auto bg-white p-6 shadow-lg rounded-lg">
    <button type="button" class="btn btn-primary" onclick="window.location.href='{{ route('pemesanan.print', $pemesanan->id) }}'">
...
<div class="mx-auto bg-white p-6 mt-7">
    <div class="flex justify-between items-start mb-6">
        ...
        <div class="text-right w-1/2">
            ...
            <h5 class="text-sm font-bold">{{ $pemesanan->invoicenumber }}</h5>
            <div class="mt-6 mb-6">
                <h5 class="text-lg font-semibold">Invoice To :</h5>
                <p class="text-sm text-gray-600">
                    {{ $pemesanan->customer->nama_customer }}<br>
                    {{ $pemesanan->customer->telepon }}<br>
    ...
    <div class="overflow-x-auto mb-6">
        ...
        <div class="text-right mt-4">
            ...
            <div class="font-bold flex justify-end">
                <div class="w-1/2 flex justify-between">
                    <span>TOTAL:</span>
                    <span>Rp. {{ number_format($pemesanan->last_total, 0, ',', '.') }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mt-10 text-right">
        <p class="text-sm mb-1">Kudus, {{ $pemesanan->tanggal }}</p>
