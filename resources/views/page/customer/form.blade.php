...
{{-- history pembelian --}}
<x-forms.textarea-input required="required" label="History Pembelian" id="history_pembelian" name="history_pembelian" :value="old('history_pembelian', $customer->history_pembelian ?? '')" />
