...
class KeperluanController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('page_bahan.keperluan.index', compact('keperluans'))->with('i', (request()->input('page', 1) - 1) * 10);
    }

    public function create(): View
    {
        return view('page_bahan.keperluan.form');
    }
    ...
    {
        return view('page_bahan.keperluan.edit', compact('keperluan'));
    }
